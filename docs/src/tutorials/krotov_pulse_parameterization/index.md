```@meta
EditURL = "krotov_pulse_parameterization.jl"
```
...
![](krotov_pulse_parameterization-11.png)

## Positive (Bounded) Controls

![](krotov_pulse_parameterization-13.png)
...
````
![](krotov_pulse_parameterization-21.png)
...
````
![](krotov_pulse_parameterization-28.png)
...
````
![](krotov_pulse_parameterization-33.png)
...
````
![](krotov_pulse_parameterization-39.png)
...
````
![](krotov_pulse_parameterization-44.png)
...
````
![](krotov_pulse_parameterization-48.png)
