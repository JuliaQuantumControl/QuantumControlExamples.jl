...
````
QuantumControlBase.ControlProblem with 4 trajectories and 4001 time steps
  trajectories:
...
````
[ Info: Set callback to store result in /net/storage/mgoerz/QuantumControlExamples.jl/examples/perfect_entanglers/GRAPE_GATE_OCT.jld2 on unexpected exit.
...
````
[ Info: Set callback to store result in /net/storage/mgoerz/QuantumControlExamples.jl/examples/perfect_entanglers/GRAPE_PE_OCT.jld2 on unexpected exit.
 iter.        J_T     |∇J_T|       ΔJ_T   FG(F)    secs
